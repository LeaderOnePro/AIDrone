...
def show_auth_screen():
    ...
    st.markdown("<h1 class='futuristic-text' style='text-align: center; color: #00ffff; font-family: \"Orbitron\", sans-serif; margin-top: 0; margin-bottom: 10px;'>深度无人机指挥中心</h1>", unsafe_allow_html=True)
    ...
    if st.button("初始化系统"):
        if api_key:
            ...
            st.markdown("<div style='color: #00ffff; background-color: rgba(0, 255, 255, 0.1); padding: 10px; border: 1px solid #00ffff; border-radius: 5px;'>系统初始化完成 - 欢迎使用深度无人机</div>", unsafe_allow_html=True)
...
def initialize_chat_container():
    ...
    if "chat_container" not in st.session_state:
        ...
        with chat_container:
            ...
            display_message(
                "assistant",
                "深度无人机系统已上线。我是您的AI无人机作业助手。请问有什么可以帮您？您可以请求飞行数据分析、传感器读取、维护建议或任务规划。"
            )

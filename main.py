...
def show_auth_screen():
    """Display the authentication screen with deepdrone-old information"""
    
    st.markdown("<h1 class='futuristic-text' style='text-align: center; color: #00ffff; font-family: \"Orbitron\", sans-serif; margin-top: 0; margin-bottom: 10px;'>deepdrone-old 指挥中心</h1>", unsafe_allow_html=True)
    ...
    <p><b>deepdrone-old</b>是一个先进的AI无人机作业系统：</p>
    ...
    if st.button("初始化系统"):
        if api_key:
            ...
            st.markdown("<div style='color: #00ffff; background-color: rgba(0, 255, 255, 0.1); padding: 10px; border: 1px solid #00ffff; border-radius: 5px;'>系统初始化完成 - 欢迎使用deepdrone-old</div>", unsafe_allow_html=True)
